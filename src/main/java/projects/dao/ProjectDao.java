...
public class ProjectDao extends DaoBase {
	...
	public List<Project> fetchAllProjects() {
		// a.Write the SQL statement to return all projects not including materials,
		// steps, or categories.
		...
		// d. Add an inner try-with-resource statement to obtain the PreparedStatement
		// from the Connection object. In a catch block, catch an Exception object.
		// Rollback the transaction and throw a new DbException, passing in the
		// Exception object as the cause.
		// e. Inside the (currently) innermost try-with-resource statement, add a
		...
		// f. Inside the new innermost try-with-resource, create and return a List of
		// Projects.
		// g. Loop through the result set. Create and assign each result row to a new
		// Project object. Add the Project object to the List of Projects.
